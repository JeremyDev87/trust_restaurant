 ...
 *
 * 설계 문서 기준:
 * - 위생등급/행정처분: 24시간 (변동 적음)
 * - 카카오/네이버 평점: 1시간 (실시간성 필요)
 * - 통합 점수: 1시간 (평점 기반)
 */
export const CACHE_TTL = {
  /** 위생등급: 24시간 (변동 적음) */
  HYGIENE_GRADE: 24 * 60 * 60,
  /** 행정처분: 24시간 (변동 적음) */
  VIOLATION: 24 * 60 * 60,
  /** 카카오맵 평점: 1시간 (실시간성 필요) */
  KAKAO_MAP: 1 * 60 * 60,
  /** 네이버 플레이스 평점: 1시간 (실시간성 필요) */
  NAVER_PLACE: 1 * 60 * 60,
  /** 식당 종합 정보: 1시간 (평점 기반) */
  RESTAURANT_INTELLIGENCE: 1 * 60 * 60,
} as const;
...
export const CACHE_PREFIX = {
  ...
  KAKAO_MAP: 'kakao',
  NAVER_PLACE: 'naver',
  RESTAURANT_INTELLIGENCE: 'intelligence',
} as const;
